...
function main() {
  ...
  const metaErrors = validateMeta(checks[2][1].value);
  const webhookErrors = validateWebhook(checks[3][1].value);
  ...
  const totalErrors = metaErrors.length + webhookErrors.length;
  if (totalErrors > 0) {

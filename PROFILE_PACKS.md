...
Total rules: 112 (of which 1 soft-deprecated; suppress via `--no-deprecated-rules`)
...
| `fanuc.m00-while-coolant-on` | warning | — | — | Turn coolant off with M9 before an M00 program stop. |
| `fanuc.m00-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before an M00 program stop. |
| `fanuc.m00-while-canned` | warning | — | — | Cancel canned cycles with G80 before an M00 program stop. |
| `fanuc.m00-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before an M00 program stop. |
| `fanuc.m30-while-coolant-on` | warning | — | — | Turn coolant off with M9 before an M30 program end. |
| `fanuc.m30-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before an M30 program end. |
| `fanuc.m30-while-canned` | warning | — | — | Cancel canned cycles with G80 before an M30 program end. |
| `fanuc.m30-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before an M30 program end. |
| `fanuc.m02-while-coolant-on` | warning | — | — | Turn coolant off with M9 before an M02 program end. |
| `fanuc.m02-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before an M02 program end. |
| `fanuc.m02-while-canned` | warning | — | — | Cancel canned cycles with G80 before an M02 program end. |
| `fanuc.m02-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before an M02 program end. |
| `fanuc.m6-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 before a tool change (M6). |
| `fanuc.m6-while-scaling` | warning | — | — | Cancel scaling with G50 before a tool change (M6). |
| `fanuc.g28-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before G28 reference return. |
| `fanuc.g28-while-canned` | warning | — | — | Cancel canned cycles with G80 before G28 reference return. |
| `fanuc.g53-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before G53 machine-coordinate moves. |
| `fanuc.g53-while-canned` | warning | — | — | Cancel canned cycles with G80 before G53 machine-coordinate moves. |
| `fanuc.m98-without-p` | warning | — | — | Fanuc M98 subprogram calls require a P program number on the same block. |
...
| `fanuc.m00-while-scaling` | warning | — | — | Cancel scaling with G50 before an M00 program stop. |
| `fanuc.m01-while-scaling` | warning | — | — | Cancel scaling with G50 before an M01 optional stop. |
| `fanuc.m02-while-scaling` | warning | — | — | Cancel scaling with G50 before an M02 program end. |
| `fanuc.m30-while-scaling` | warning | — | — | Cancel scaling with G50 before an M30 program end. |
| `fanuc.m00-while-incremental` | warning | — | — | Restore absolute mode with G90 before an M00 program stop. |
| `fanuc.m01-while-incremental` | warning | — | — | Restore absolute mode with G90 before an M01 optional stop. |
| `fanuc.m02-while-incremental` | warning | — | — | Restore absolute mode with G90 before an M02 program end. |
| `fanuc.m30-while-incremental` | warning | — | — | Restore absolute mode with G90 before an M30 program end. |
| `fanuc.g30-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before G30 secondary reference return. |
| `fanuc.g30-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 before G30 secondary reference return. |
| `fanuc.g28-while-scaling` | warning | — | — | Cancel scaling with G50 before G28 reference return. |
| `fanuc.g53-while-scaling` | warning | — | — | Cancel scaling with G50 before G53 machine-coordinate moves. |
| `fanuc.m5-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 when stopping the spindle with M5. |
| `fanuc.m5-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 when stopping the spindle with M5. |
| `fanuc.m5-while-scaling` | warning | — | — | Cancel scaling with G50 when stopping the spindle with M5. |
| `fanuc.g0-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before G0 rapid moves. |
| `fanuc.canned-without-z` | warning | — | — | Canned cycles need a Z depth on the cycle block or earlier in the active cycle. |
| `fanuc.canned-without-r` | warning | — | — | Canned cycles need an R plane on the cycle block or earlier in the active cycle. |
| `fanuc.g65-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before G65 macro calls. |
| `fanuc.g65-while-canned` | warning | — | — | Cancel canned cycles with G80 before G65 macro calls. |
| `fanuc.g43-and-g80-same-block` | warning | — | — | Apply tool length and cancel canned cycles on separate blocks. |
| `fanuc.g41-and-g80-same-block` | warning | — | — | Apply cutter compensation and cancel canned cycles on separate blocks. |
| `fanuc.g0-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 before G0 rapid moves. |
| `fanuc.g0-while-scaling` | warning | — | — | Cancel scaling with G50 before G0 rapid moves. |
| `fanuc.g0-while-coolant-on` | warning | — | — | Turn coolant off with M9 before G0 rapid moves. |
| `fanuc.g0-while-incremental` | warning | — | — | Restore absolute mode with G90 before G0 rapid moves. |
| `fanuc.g65-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 before G65 macro calls. |
| `fanuc.g65-while-scaling` | warning | — | — | Cancel scaling with G50 before G65 macro calls. |
| `fanuc.g65-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before G65 macro calls. |
| `fanuc.g65-while-coolant-on` | warning | — | — | Turn coolant off with M9 before G65 macro calls. |
| `fanuc.g65-while-incremental` | warning | — | — | Restore absolute mode with G90 before G65 macro calls. |
| `fanuc.m98-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before M98 subprogram calls. |
| `fanuc.m98-while-canned` | warning | — | — | Cancel canned cycles with G80 before M98 subprogram calls. |
| `fanuc.m98-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before M98 subprogram calls. |
| `fanuc.m98-while-rotation` | warning | — | — | Cancel coordinate rotation with G69 before M98 subprogram calls. |
| `fanuc.m98-while-scaling` | warning | — | — | Cancel scaling with G50 before M98 subprogram calls. |
| `fanuc.m98-while-coolant-on` | warning | — | — | Turn coolant off with M9 before M98 subprogram calls. |
| `fanuc.m98-while-incremental` | warning | — | — | Restore absolute mode with G90 before M98 subprogram calls. |
| `fanuc.g30-while-scaling` | warning | — | — | Cancel scaling with G50 before G30 secondary reference return. |
| `fanuc.g4-while-cutter-comp` | warning | — | — | Cancel cutter compensation with G40 before G4 dwell. |
| `fanuc.g4-while-canned` | warning | — | — | Cancel canned cycles with G80 before G4 dwell. |
| `fanuc.g4-while-tool-length` | warning | — | — | Cancel tool length compensation with G49 before G4 dwell. |
| `fanuc.g68-and-g80-same-block` | warning | — | — | Apply coordinate rotation and cancel canned cycles on separate blocks. |
| `fanuc.g51-and-g80-same-block` | warning | — | — | Apply scaling and cancel canned cycles on separate blocks. |
...
- **Severity:** warning
- **Matcher:** `/M98 without P on the same block/`

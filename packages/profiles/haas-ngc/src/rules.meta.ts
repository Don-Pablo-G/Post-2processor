...
export const haasNgcRuleDocs: ProfileRuleDoc[] = [
  ...
  {
    id: "haas.m97-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M97 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before the local subprogram call (M97).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM97 P1000\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM97 P1000\nM30\n"
  },
  {
    id: "haas.m99-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M99 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before subprogram return (M99).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM99\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM99\nM30\n"
  },
  {
    id: "haas.g10-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /G10 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before G10 data setting.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG10 L2 P1 X0\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG10 L2 P1 X0\nM30\n"
  },
  {
    id: "haas.g92-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /G92 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before shifting coordinates (G92).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG92 X0 Y0\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG92 X0 Y0\nM30\n"
  },
  {
    id: "haas.g52-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /G52 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before a local offset (G52).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG52 X0 Y0\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG52 X0 Y0\nM30\n"
  },
  {
    id: "haas.work-offset-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Work offset \(G54-G59\/G154\) while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before selecting a work offset (G54-G59/G154).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG55\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG55\nM30\n"
  },
  {
    id: "haas.plane-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Plane select \(G17\/G18\/G19\) while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before changing plane (G17/G18/G19).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG18\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG18\nM30\n"
  },
  {
    id: "haas.unit-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Unit select \(G20\/G21\) while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before changing units (G20/G21).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG21\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG21\nM30\n"
  },
  {
    id: "haas.feed-mode-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Feed mode select \(G93\/G94\/G95\) while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before changing feed mode (G93/G94/G95).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG94\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG94\nM30\n"
  },
  {
    id: "haas.path-mode-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Path mode select \(G61\/G64\) while through-spindle coolant \(M88\) is still active/,
  ...
  {
    id: "haas.g92-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G92 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before shifting coordinates (G92).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG92 X0.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG92 X0.\nM30\n"
  },
  {
    id: "haas.g52-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G52 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before a local offset (G52).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG52 X1.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG52 X1.\nM30\n"
  },
  {
    id: "haas.plane-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Plane select \(G17\/G18\/G19\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing plane (G17/G18/G19).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG18\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG18\nM30\n"
  },
  {
    id: "haas.unit-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Unit select \(G20\/G21\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing units (G20/G21).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG20\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG20\nM30\n"
  },
  {
    id: "haas.feed-mode-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Feed mode select \(G93\/G94\/G95\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing feed mode (G93/G94/G95).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG94\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG94\nM30\n"
  },
  {
    id: "haas.path-mode-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Path mode select \(G61\/G64\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing path mode (G61/G64).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG64\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG64\nM30\n"
  },
  {
    id: "haas.distance-mode-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Distance mode select \(G90\/G91\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing distance mode (G90/G91).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG90\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG90\nM30\n"
  },
  {
    id: "haas.g40-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G40 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before canceling cutter compensation (G40).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG40\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG40\nM30\n"
  },
  {
    id: "haas.g49-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G49 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before canceling tool length (G49).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG49\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG49\nM30\n"
  },
  {
    id: "haas.g80-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G80 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before canceling the canned cycle (G80).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG80\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG80\nM30\n"
  },
  {
    id: "haas.g69-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G69 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before canceling coordinate rotation (G69).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG69\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG69\nM30\n"
  },
  {
    id: "haas.g50-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G50 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before canceling scaling (G50).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG50\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG50\nM30\n"
  },
  {
    id: "haas.g41-g42-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G41\/G42 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before cutter compensation (G41/G42).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG41 D1\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG41 D1\nM30\n"
  },
  {
    id: "haas.g43-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G43 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before applying tool length (G43).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG43 H1 Z1.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG43 H1 Z1.\nM30\n"
  },
  {
    id: "haas.g68-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G68 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before coordinate rotation (G68).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG68 R45.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG68 R45.\nM30\n"
  },
  {
    id: "haas.g51-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G51 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before scaling (G51).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG51\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG51\nM30\n"
  },
  {
    id: "haas.m88-while-spindle-orient",
    severity: "warning",
    messageMatcher: /M88 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before through-spindle coolant (M88).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM88\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nM88\nM30\n"
  },
  {
    id: "haas.coolant-on-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Coolant on \(M7\/M8\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before turning coolant on (M7/M8).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM8\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nM8\nM30\n"
  },
  {
    id: "haas.m00-while-spindle-orient",
    severity: "warning",
    messageMatcher: /M00 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before program stop (M00).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM00\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nM00\nM30\n"
  },
  {
    id: "haas.m01-while-spindle-orient",
    severity: "warning",
    messageMatcher: /M01 while spindle orientation \(M19\) is still latched/,
  ...
  {
    id: "haas.g0-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /G0 rapid while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before rapid moves (G0).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG0 X0. Y0.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nG0 X0. Y0.\nM30\n"
  },
  {
    id: "haas.m00-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M00 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before program stop (M00).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM00\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM00\nM30\n"
  },
  {
    id: "haas.m01-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M01 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before optional stop (M01).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM01\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM01\nM30\n"
  },
  {
    id: "haas.coolant-on-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Coolant on \(M7\/M8\) while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before flood/mist coolant (M7/M8).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM8\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM8\nM30\n"
  },
  {
    id: "haas.m9-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M9 while through-spindle coolant \(M88\) is still active/,
    summary: "M9 does not clear through-spindle coolant; turn it off with M89 first.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM9\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM9\nM30\n"
  },
  {
    id: "haas.m88-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /M88 while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before re-enabling M88.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM88\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM88\nM30\n"
  },
  {
    id: "haas.m89-while-through-spindle-coolant-off",
    severity: "warning",
    messageMatcher: /M89 while through-spindle coolant \(M88\) is not active/,
    summary: "Avoid M89 when through-spindle coolant is already off.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM89\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nM30\n"
  },
  {
    id: "haas.feed-motion-while-spindle-orient",
    severity: "warning",
    messageMatcher: /G1\/G2\/G3 while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before feed motion (G1/G2/G3).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG1 X1. F100.\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nG1 X1. F100.\nM30\n"
  },
  {
    id: "haas.s-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Spindle speed \(S\) while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before changing spindle speed (S).",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nS1500\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nS1500\nM30\n"
  },
  {
    id: "haas.canned-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Canned cycle \(G73\/G74\/G76\/G81-G89\) while spindle orientation \(M19\) is still latched/,
  ...
  {
    id: "haas.b-while-spindle-orient",
    severity: "warning",
    messageMatcher: /B rotary word while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before an orphan B rotary word.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nB10.\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG0 B10.\nM5\nM30\n"
  },
  {
    id: "haas.c-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /C rotary word while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before an orphan C rotary word.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nC10.\nM89\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nG0 C10.\nM89\nM5\nM30\n"
  },
  {
    id: "haas.c-while-spindle-orient",
    severity: "warning",
    messageMatcher: /C rotary word while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before an orphan C rotary word.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nC10.\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nG0 C10.\nM5\nM30\n"
  },
  {
    id: "haas.q-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /Q word while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before using Q outside a peck cycle.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nQ0.1\nM89\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nQ0.1\nM5\nM30\n"
  },
  {
    id: "haas.q-while-spindle-orient",
    severity: "warning",
    messageMatcher: /Q word while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before using Q outside a peck cycle.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nQ0.1\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nQ0.1\nM30\n"
  },
  {
    id: "haas.r-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /R word while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before using R outside canned/arc/rotation context.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nR0.1\nM89\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nR0.1\nM5\nM30\n"
  },
  {
    id: "haas.r-while-spindle-orient",
    severity: "warning",
    messageMatcher: /R word while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before using R outside canned/arc/rotation context.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nR0.1\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nR0.1\nM30\n"
  },
  {
    id: "haas.p-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /P word while through-spindle coolant \(M88\) is still active/,
    summary: "Turn through-spindle coolant off with M89 before using P outside call/dwell/scaling/canned context.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nP100\nM89\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM88\nM89\nP100\nM5\nM30\n"
  },
  {
    id: "haas.p-while-spindle-orient",
    severity: "warning",
    messageMatcher: /P word while spindle orientation \(M19\) is still latched/,
    summary: "Clear latched M19 spindle orientation with M3/M4/M5 before using P outside call/dwell/scaling/canned context.",
    positiveSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nP100\nM5\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nS1200 M3\nM19\nM5\nP100\nM30\n"
  },
  {
    id: "haas.ijk-while-through-spindle-coolant",
    severity: "warning",
    messageMatcher: /I\/J\/K word while through-spindle coolant \(M88\) is still active/,
  ...
  {
    id: "haas.g68-and-g49-same-block",
    severity: "warning",
    messageMatcher: /G68 and G49 on the same block/,
    summary: "Apply coordinate rotation and cancel tool length on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG68 X0 Y0 R45. G49\nG69\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG68 X0 Y0 R45.\nG49\nG69\nM30\n"
  },
  {
    id: "haas.g51-and-g49-same-block",
    severity: "warning",
    messageMatcher: /G51 and G49 on the same block/,
    summary: "Apply scaling and cancel tool length on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG51 P2. G49\nG50\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG51 P2.\nG49\nG50\nM30\n"
  },
  {
    id: "haas.g43-and-g69-same-block",
    severity: "warning",
    messageMatcher: /G43 and G69 on the same block/,
    summary: "Apply tool length and cancel coordinate rotation on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG43 H1 Z25. G69\nG49\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG43 H1 Z25.\nG69\nG49\nM30\n"
  },
  {
    id: "haas.g41-and-g69-same-block",
    severity: "warning",
    messageMatcher: /G41\/G42 and G69 on the same block/,
    summary: "Apply cutter compensation and cancel coordinate rotation on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG41 D1 G69\nG40\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG41 D1\nG69\nG40\nM30\n"
  },
  {
    id: "haas.g51-and-g69-same-block",
    severity: "warning",
    messageMatcher: /G51 and G69 on the same block/,
    summary: "Apply scaling and cancel coordinate rotation on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG51 P2. G69\nG50\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG51 P2.\nG69\nG50\nM30\n"
  },
  {
    id: "haas.g43-and-g50-same-block",
    severity: "warning",
    messageMatcher: /G43 and G50 on the same block/,
    summary: "Apply tool length and cancel scaling on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG43 H1 Z25. G50\nG49\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG43 H1 Z25.\nG50\nG49\nM30\n"
  },
  {
    id: "haas.g41-and-g50-same-block",
    severity: "warning",
    messageMatcher: /G41\/G42 and G50 on the same block/,
    summary: "Apply cutter compensation and cancel scaling on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG41 D1 G50\nG40\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG41 D1\nG50\nG40\nM30\n"
  },
  {
    id: "haas.g68-and-g50-same-block",
    severity: "warning",
    messageMatcher: /G68 and G50 on the same block/,
    summary: "Apply coordinate rotation and cancel scaling on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG68 X0 Y0 R45. G50\nG69\nM30\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG68 X0 Y0 R45.\nG50\nG69\nM30\n"
  },
  {
    id: "haas.g65-and-m00-same-block",
    severity: "warning",
    messageMatcher: /G65 and M00 on the same block/,
    summary: "Run a G65 macro call and M00 program stop on separate blocks.",
    positiveSnippet: "O0001\nT1 M6\nG54\nG65 P9010 M00\n",
    negativeSnippet: "O0001\nT1 M6\nG54\nG65 P9010\nM00\n"
  },
  {
    id: "haas.g65-and-m01-same-block",
    severity: "warning",
    messageMatcher: /G65 and M01 on the same block/,

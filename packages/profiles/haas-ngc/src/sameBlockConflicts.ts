...
export const SAME_BLOCK_RESIDUAL_CONFLICTS: readonly Conflict[] = [
  ...
  ["g68", "g49", "G68 and G49 on the same block — apply coordinate rotation and cancel tool length on separate blocks."],
  ["g51", "g49", "G51 and G49 on the same block — apply scaling and cancel tool length on separate blocks."],
  ["g43", "g69", "G43 and G69 on the same block — apply tool length and cancel coordinate rotation on separate blocks."],
  ["g41Or42", "g69", "G41/G42 and G69 on the same block — apply cutter compensation and cancel coordinate rotation on separate blocks."],
  ["g51", "g69", "G51 and G69 on the same block — apply scaling and cancel coordinate rotation on separate blocks."],
  ["g43", "g50", "G43 and G50 on the same block — apply tool length and cancel scaling on separate blocks."],
  ...
  ["g65", "g41Or42", "G65 and G41/G42 on the same block — macro call and cutter compensation separately."],
  ["g65", "g43", "G65 and G43 on the same block — macro call and tool length separately."],
  ["g65", "g68", "G65 and G68 on the same block — macro call and coordinate rotation separately."],
  ["g65", "g51", "G65 and G51 on the same block — macro call and scaling separately."],
  ["g65", "g80", "G65 and G80 on the same block — macro call and canned-cycle cancel separately."],
  ["g65", "g40", "G65 and G40 on the same block — macro call and cutter-comp cancel separately."],
  ["g65", "g49", "G65 and G49 on the same block — macro call and tool-length cancel separately."],
  ["g65", "g69", "G65 and G69 on the same block — macro call and rotation cancel separately."],
  ["g65", "g50", "G65 and G50 on the same block — macro call and scaling cancel separately."],
  [
    "g65",
    "workOffset",
    "G65 and work offset (G54-G59/G154) on the same block — macro call and work-offset select separately."
  ],
  ["m98", "m00", "M98 and M00 on the same block — subprogram call and program stop separately."],
  ["m98", "m01", "M98 and M01 on the same block — subprogram call and optional stop separately."],
  ["m98", "m02", "M98 and M02 on the same block — subprogram call and program end separately."],
  ["m98", "m30", "M98 and M30 on the same block — subprogram call and program end separately."],
  ["m97", "m00", "M97 and M00 on the same block — subprogram call and program stop separately."],
  ["m97", "m01", "M97 and M01 on the same block — subprogram call and optional stop separately."],
  ["m97", "m02", "M97 and M02 on the same block — subprogram call and program end separately."],
  ["m97", "m30", "M97 and M30 on the same block — subprogram call and program end separately."],

...
export type SimulationTraceEntry = {
    ...
    event?: {
        kind: "alarm" | "message_stop" | "subprogram_call" | "subprogram_return" | "subprogram_repeat" | "call_depth_limit" | "main_m99";
        message: string;
        parameter?: 3000 | 3006;
        code?: number;
        program?: number;
...
export type CriticalEvent = {
    kind: "first_motion" | "first_cut" | "first_tool_change" | "deepest_z" | "first_wcs_change" | "program_end";
    blockIndex: number;
    description: string;
};
...
export type TemplateLibrary = {
    ...
    settings?: {
        parameterDefaults?: Record<string, {
            presetId?: string;
            startAt?: number;
            blacklistedParameters?: number[];
        }>;
...
export type ExportedArtifact = {
    kind: "setup_txt" | "setup_md" | "proveout_nc" | "fixture_summary_txt" | "fixture_summary_md" | "timeline_txt" | "timeline_md" | "findings_txt" | "findings_md";
    path: string;
};

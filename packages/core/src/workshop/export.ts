import type { ExportArtifactsInput, ExportArtifactsResult } from "../types.js";

export async function exportWorkshopArtifacts(input: ExportArtifactsInput): Promise<ExportArtifactsResult> {
  ...
  const artifacts: ExportArtifactsResult["artifacts"] = [
